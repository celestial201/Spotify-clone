...
const {seekBar,seekBg,playStatus,play,pause,track,time,previous,next,seekSong} = useContext(PlayerContext)
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full h-[90px] bg-black flex items-center text-white px-4 border-t border-gray-700">
      ...
      <div onClick={seekSong} ref={seekBg} className="w-[60vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointer h-1">
